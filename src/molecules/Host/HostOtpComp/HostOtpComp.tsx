  ...
  useEffect(() => {
    if (showModal) {
      ...
      const redirectTimer = setTimeout(() => {
        ...
        router.push("/host/onboarding"); // go to pnboarding page
      }, 5000);
