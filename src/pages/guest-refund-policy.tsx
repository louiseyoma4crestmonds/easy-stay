...
function GuestRefundPolicy() {
  ...
  return (
    <main className="min-h-screen flex flex-col ">
      <HeroBanner
        backgroundImg="/images/guest-bg.png"
        primaryText="Guest Refund Policy"
      ...
      <section className="bg-gray-50 px-5 md:px-24 py-12">
        <div className="border border-gray-100 shadow-lg bg-white rounded-lg p-5 md:p-10">
          <div className="w-full md:w-[70%] text-gray-800 text-base ">
            <p className="font-bold mb-4 ">Guest Refund Policy </p>
            <p className="mb-4 ">
...
export default GuestRefundPolicy;
