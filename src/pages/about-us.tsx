...
export default function AboutUs() {
  ...
  return (
    <main className="min-h-screen flex flex-col ">
      ...
      {/* TEXT SECTION */}
      <section className="bg-gray-50 px-5 md:px-36 py-10 md:py-24">
        <div className="w-full md:w-[70%]">
          <p className="text-gray-800 font-normal text-sm md:text-xl mb-14">
          ...
          <p className="text-primary-500 font-normal text-sm md:text-xl mb-6">
            We’ve helped hundreds of people find a shortlet
          </p>

          <p className="text-gray-900 font-semibold text-2xl md:text-5xl mb-6">
            We’re only just getting started on our journey
          </p>

          <div className="w-[80%] flex flex-col md:flex-row md:items-center md:gap-28 mt-16">
            ...
            <div className="flex flex-col mt-8 ">
              <p className="font-semibold text-primary-600 text-5xl md:text-6xl ">
                100%
              </p>
          ...
          <div className="md:w-[80%] flex flex-col md:flex-row md:items-center md:gap-28 mt-8 md:mt-16">
            <div className="flex flex-col ">
              <p className="font-semibold text-primary-600 text-5xl md:text-6xl ">
                500+
              </p>
      ...
      <section className="border bg-primary-50 border-gray-300 ">
        <div className="flex flex-col items-center justify-center py-8 md:py-16 ">
          <div className=" flex flex-col items-center">
            ...
            <p className="text-gray-900 font-semibold text-2xl md:text-4xl pt-2  ">
              Let us tell you about our values
            </p>
            <p className="text-gray-500 font-normal text-center px-5 md:px-0 text-base md:text-xl pt-4 ">
              Our shared values keep us connected and guide us as one team.
            </p>
          </div>
          <div className=" mt-8 md:mt-14 w-full gap-6 flex flex-col md:flex-row items-center justify-center ">
            <div className="w-[80%] md:w-[28%] flex flex-col items-center">
              <img
                src="/images/featured-icon-host.png"
                alt="Easy Stay Logo"
                className="h-10 w-10"
              />
              <p className="text-gray-800 font-medium text-base md:text-xl  py-4 ">
                Powering Hosts
              </p>
          ...
          <div className="mt-14 w-full gap-6 flex flex-col md:flex-row items-center justify-center ">
            <div className="w-[80%] md:w-[28%] flex flex-col items-center">
              <img
